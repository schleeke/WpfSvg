    ...
    internal static class FileUtils {
        ...
        public static string MakeRelativePath(string fromPath, PathIs fromIs, string toPath, PathIs toIs) {
            ...
            if (!fromPath.EndsWith(System.IO.Path.DirectorySeparatorChar.ToString()) &&
                !fromPath.EndsWith(System.IO.Path.AltDirectorySeparatorChar.ToString()) &&
                fromIs == PathIs.Folder)
                fromPath += System.IO.Path.DirectorySeparatorChar;
            if (!toPath.EndsWith(System.IO.Path.DirectorySeparatorChar.ToString()) &&
                !toPath.EndsWith(System.IO.Path.AltDirectorySeparatorChar.ToString()) &&
                toIs == PathIs.Folder)
                toPath += System.IO.Path.DirectorySeparatorChar;
